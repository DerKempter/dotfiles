...
description: >-
  Global developer instructions, persona, and workflow protocol.
  CRITICAL: Always consult and strictly apply for any coding task, architecture proposal,
  file modification, code review, git workflow, or CLI execution across all workspaces.
always_apply: true
---
