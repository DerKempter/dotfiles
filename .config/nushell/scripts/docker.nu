...
# Safety wrapper for docker rm (keeps the custom safety logic active and integrates autocomplete!)
export def "docker rm" [
    container?: string@"nu-complete docker containers"  # The container to remove
